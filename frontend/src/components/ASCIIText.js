...
class AsciiFilter {
  constructor(renderer, { fontSize, fontFamily, charset, invert } = {}) {
    ...
    this.fontFamily = fontFamily ?? "'IBM Plex Mono', 'Pretendard', 'Courier New', monospace";
...
class CanvasTxt {
  ...
  render() {
    ...
    lines.forEach((line, index) => {
      ...
      this.context.fillText(line, centerX, yPos);
    });
  }
...
class CanvAscii {
  ...
  setRenderer() {
    ...
    this.filter = new AsciiFilter(this.renderer, {
      fontFamily: "'IBM Plex Mono', 'Pretendard', 'Courier New', monospace",
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: linear-gradient(135deg, #00ffff 0%, #00cccc 50%, #00aaaa 100%);
